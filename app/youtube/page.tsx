    ...
    <section className="bg-red-50 py-16">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <p className="text-center text-gray-600 max-w-2xl mx-auto mb-8">
          Download any YouTube video in HD quality. Just paste the URL and get
              ...
              <div className="mt-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {videoInfo.qualities.map((quality) => (
                    <label
                      key={quality.quality}
                      className={`flex items-center justify-between p-4 rounded-lg border cursor-pointer transition-colors ${selectedQuality === quality.quality ? "border-red-500 bg-red-50" : "border-gray-200 hover:border-red-200"}`}
                    >
              ...
              <div className="mt-6 border-t pt-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <button
                    ...
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${watermarkSettings.enabled ? "bg-red-600" : "bg-gray-200"}`}
                  >
                    <span
                      className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${watermarkSettings.enabled ? "translate-x-6" : "translate-x-1"}`}
                    />
                  </button>
                </div>
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-3">
                      <button
                        ...
                        className={`flex items-center justify-center gap-2 p-3 rounded-lg border ${watermarkSettings.mode === "auto" ? "border-red-500 bg-red-50 text-red-600" : "border-gray-200 hover:border-red-200"}`}
                      >
                        <ScanLine size={18} />
                        Auto Detect
                      </button>
                      <button
                        ...
                        className={`flex items-center justify-center gap-2 p-3 rounded-lg border ${watermarkSettings.mode === "manual" ? "border-red-500 bg-red-50 text-red-600" : "border-gray-200 hover:border-red-200"}`}
                      >
